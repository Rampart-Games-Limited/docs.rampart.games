...
### How To Use Console Commands  <a href="#id-2-how-to-use-console-commands-in-scum" id="id-2-how-to-use-console-commands-in-scum"></a>

1. add yourself  as an admin on the  "AdminUsers.ini" file.
2. Join the SCUM server, and open the in-game chat box,  Default keybind is "T".
3. Enter the command you want to run, including the "#" prefix.&#x20;
